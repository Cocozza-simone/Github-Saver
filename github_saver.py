...
class GitHubSaver:
    ...
    def __init__(self, username: str = "Cocozza-simone", token: Optional[str] = None):
        ...
        self.project_name: str = os.path.basename(os.getcwd()).replace(" ", "-")
    ...
    def save_project(self, commit_message: Optional[str] = None) -> None:
        ...
        Args:
            commit_message (Optional[str]): A custom commit message. If None, an
                                            automatic versioned message is generated.
        """
        ...
        # 3. Create commit message and version
